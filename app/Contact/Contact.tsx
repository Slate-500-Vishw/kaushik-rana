  ...
  return (
    <>
      ...
      <div className="flex flex-col md:hidden">
        <div className="w-full mt-20 mt-10 md:px-10 md:ml-15 ml-6">
          <h1 className="text-5xl heading dark-accent-color">
            Get in touch with
            <br />
            Dr. Kaushikkumar Rana
        ...
        <div className="mt-10 md:px-10 md:ml-15 ml-6 w-full mr-10 md:mr-10">
          <h1 className="text-3xl md:text-4xl heading accent-color">
            Contact Info
          </h1>
          <div className="mt-5">
            ...
            <div>
              ...
              <div className="mt-3 flex gap-2">
                ...
                <div className="flex justify-center h-[50px] items-center mr-10">
                  <span className="text-xl heading">
                    13863 80A Avenue, Surrey, BC V3W 8V8 Canada
                  </span>
                </div>
            ...
            <h2 className="dark-accent-color text-xl md:text-2xl mt-5">
              Contact Info:
            </h2>
            <div>
              <div className="mt-3 flex gap-2">
